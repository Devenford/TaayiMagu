    ...
    'content': [
      {
        ...
        'answer': 'ಹಣ್ಣುಗಳು, ತರಕಾರಿಗಳು, ಧಾನ್ಯಗಳು, ನೇರ ಪ್ರೋಟೀನ್ ಮತ್ತು ಡೈರಿಗಳೊಂದಿಗೆ ಸಮತೋಲಿತ ಆಹಾರದ ಮೇಲೆ ಕೇಂದ್ರೀಕರಿಸಿ. ಬ್ಯಾಕ್ಟೀರಿಯಾವನ್ನು ತಪ್ಪಿಸಲು ಉತ್ಪನ್ನಗಳನ್ನು ತೊಳೆಯಿರಿ ಮತ್ತು ಮಾಂಸವನ್ನು ಚೆನ್ನಾಗಿ ಬೇಯಿಸಿ.'
      },
      {
        'question': 'ನಾನು ಸುಶಿ ಅಥವಾ ಅಪರೂಪದ ಸ್ಟೀಕ್ ಹೊಂದಬಹುದೇ?',
        'answer': 'ಭ್ರೂಣಕ್ಕೆ ಹಾನಿ ಮಾಡುವ ಬ್ಯಾಕ್ಟೀರಿಯಾ ಮತ್ತು ಪರಾವಲಂಬಿಗಳ ಅಪಾಯದಿಂದಾಗಿ ಗರ್ಭಾವಸ್ಥೆಯಲ್ಲಿ ಕಚ್ಚಾ ಅಥವಾ ಬೇಯಿಸದ ಮೀನು ಮತ್ತು ಮಾಂಸವನ್ನು ತಪ್ಪಿಸುವುದು ಉತ್ತಮ.'
      },
      {
        'question': 'ಗರ್ಭಾವಸ್ಥೆಯಲ್ಲಿ ಆಹಾರಕ್ರಮವು ಸುರಕ್ಷಿತವೇ?',
        'answer': 'ಗರ್ಭಾವಸ್ಥೆಯಲ್ಲಿ ಆಹಾರವನ್ನು ಶಿಫಾರಸು ಮಾಡುವುದಿಲ್ಲ. ಬದಲಾಗಿ, ನಿಮಗೆ ಮತ್ತು ನಿಮ್ಮ ಮಗುವಿಗೆ ಸಾಕಷ್ಟು ಪೋಷಕಾಂಶಗಳನ್ನು ಒದಗಿಸುವ ಆರೋಗ್ಯಕರ, ಸಮತೋಲಿತ ಆಹಾರಕ್ಕಾಗಿ ಗುರಿಯಿರಿಸಿ.'
      },
      {
        'question': 'ಗಿಡಮೂಲಿಕೆ ಚಹಾಗಳು ಮತ್ತು ಪೂರಕಗಳ ಬಗ್ಗೆ ಏನು?',
        'answer': 'ಕೆಲವು ಅಸುರಕ್ಷಿತವಾಗಿರಬಹುದು. ಗರ್ಭಾವಸ್ಥೆಯಲ್ಲಿ ಯಾವುದೇ ಗಿಡಮೂಲಿಕೆಗಳು ಅಥವಾ ಪೂರಕಗಳನ್ನು ತೆಗೆದುಕೊಳ್ಳುವ ಮೊದಲು ನಿಮ್ಮ ಆರೋಗ್ಯ ಪೂರೈಕೆದಾರರೊಂದಿಗೆ ಚರ್ಚಿಸಿ.'
      },
      {
        'question': 'ನಾನು ಡೆಲಿ ಮಾಂಸವನ್ನು ತಿನ್ನಬಹುದೇ?',
        'answer': 'ಲಿಸ್ಟರಿಯೊಸಿಸ್ ಅಪಾಯವನ್ನು ತಡೆಗಟ್ಟಲು ಡೆಲಿ ಮಾಂಸವನ್ನು ಬಿಸಿಯಾಗಿ ಬಿಸಿ ಮಾಡದ ಹೊರತು ಅವುಗಳನ್ನು ತಪ್ಪಿಸಬೇಕು.'
      },
    ],
  },
  {
    ...
    'content': [
      {
        ...
        'answer': 'ಹೆಚ್ಚಿನ ಮಹಿಳೆಯರು ಸುರಕ್ಷಿತವಾಗಿ ಮಧ್ಯಮ ವ್ಯಾಯಾಮದಲ್ಲಿ ತೊಡಗಬಹುದು. ನಿಮ್ಮ ನಿರ್ದಿಷ್ಟ ಅಗತ್ಯಗಳಿಗೆ ವ್ಯಾಯಾಮ ಯೋಜನೆಯನ್ನು ಹೊಂದಿಸಲು ನಿಮ್ಮ ವೈದ್ಯರನ್ನು ಸಂಪರ್ಕಿಸಿ.'
      },
      {
        'question': 'ಪ್ರಸವಪೂರ್ವ ಖಿನ್ನತೆಯ ಚಿಹ್ನೆಗಳು ಯಾವುವು?',
        'answer': 'ರೋಗಲಕ್ಷಣಗಳು ನಿರಂತರ ದುಃಖ, ಆತಂಕ ಮತ್ತು ಚಟುವಟಿಕೆಗಳಲ್ಲಿ ಆಸಕ್ತಿಯ ನಷ್ಟವನ್ನು ಒಳಗೊಂಡಿರುತ್ತದೆ. ನೀವು ಇವುಗಳನ್ನು ಅನುಭವಿಸಿದರೆ, ಆರೋಗ್ಯ ವೃತ್ತಿಪರರಿಂದ ಸಹಾಯ ಪಡೆಯಿರಿ.'
      },
      {
        'question': 'ಗರ್ಭಾವಸ್ಥೆಯಲ್ಲಿ ನಾನು ಪ್ರಯಾಣಿಸಬಹುದೇ?',
        'answer': 'ಸಾಮಾನ್ಯವಾಗಿ, ಪ್ರಯಾಣ ಸುರಕ್ಷಿತವಾಗಿದೆ, ಆದರೆ ನಿಮ್ಮ ವೈದ್ಯರೊಂದಿಗೆ ಪರೀಕ್ಷಿಸಿ, ವಿಶೇಷವಾಗಿ ಕೊನೆಯ ತ್ರೈಮಾಸಿಕದಲ್ಲಿ ಅಥವಾ ನೀವು ಗರ್ಭಾವಸ್ಥೆಯ ತೊಡಕುಗಳನ್ನು ಹೊಂದಿದ್ದರೆ.'
      },
      {
        'question': 'ಬೆಳಗಿನ ಬೇನೆಯನ್ನು ನಾನು ಹೇಗೆ ನಿರ್ವಹಿಸಬಹುದು?',
        'answer': 'ಸಣ್ಣ, ಆಗಾಗ್ಗೆ ಊಟವನ್ನು ಸೇವಿಸಿ, ವಾಸನೆಯನ್ನು ಪ್ರಚೋದಿಸುವುದನ್ನು ತಪ್ಪಿಸಿ ಮತ್ತು ನಿಮ್ಮ ವೈದ್ಯರನ್ನು ಸಂಪರ್ಕಿಸಿದ ನಂತರ ಶುಂಠಿ ಅಥವಾ ವಿಟಮಿನ್ ಬಿ 6 ಪೂರಕಗಳನ್ನು ಪರಿಗಣಿಸಿ.'
      },
      {
        'question': 'ತುಂಬಾ ಸುಸ್ತಾಗುವುದು ಸಹಜವೇ?',
        'answer': 'ಹಾರ್ಮೋನುಗಳ ಬದಲಾವಣೆಗಳು ಮತ್ತು ಗರ್ಭಧಾರಣೆಯನ್ನು ಬೆಂಬಲಿಸಲು ದೇಹದ ಹೆಚ್ಚುವರಿ ಕೆಲಸದಿಂದಾಗಿ ಆಯಾಸವು ಸಾಮಾನ್ಯವಾಗಿದೆ.'
      },
    ],
  },
  {
    ...
    'content': [
      {
        ...
        'answer': 'ಒಂದು ವಿಶಿಷ್ಟವಾದ ವೇಳಾಪಟ್ಟಿ ಪ್ರತಿ 4-6 ವಾರಗಳವರೆಗೆ 32 ವಾರಗಳವರೆಗೆ, ನಂತರ ಹೆಚ್ಚಾಗಿ. ಹೆಚ್ಚಿನ ಅಪಾಯದ ಗರ್ಭಧಾರಣೆಗೆ ಹೆಚ್ಚಿನ ಭೇಟಿಗಳು ಬೇಕಾಗಬಹುದು.'
      },
      {
        'question': 'ಬೆಳವಣಿಗೆಯ ಸ್ಕ್ಯಾನ್ ಎಂದರೇನು?',
        'answer': 'ಬೆಳವಣಿಗೆಯ ಸ್ಕ್ಯಾನ್ ಮಗುವಿನ ಗಾತ್ರ ಮತ್ತು ಸ್ಥಾನವನ್ನು ಪರೀಕ್ಷಿಸಲು ಅಲ್ಟ್ರಾಸೌಂಡ್ ಆಗಿದೆ, ಇದನ್ನು ಸಾಮಾನ್ಯವಾಗಿ ಮೂರನೇ ತ್ರೈಮಾಸಿಕದಲ್ಲಿ ನಡೆಸಲಾಗುತ್ತದೆ.'
      },
      {
        'question': 'ನನ್ನ ಸಂಗಾತಿ ನೇಮಕಾತಿಗಳಿಗೆ ಹಾಜರಾಗಬಹುದೇ?',
        'answer': 'ಪಾಲುದಾರರನ್ನು ಸಾಮಾನ್ಯವಾಗಿ ಸ್ವಾಗತಿಸಲಾಗುತ್ತದೆ, ಆದರೆ ಸಾಂಕ್ರಾಮಿಕ ಸಮಯದಲ್ಲಿ ಯಾವುದೇ ಸಂಭಾವ್ಯ ನಿರ್ಬಂಧಗಳ ಕಾರಣದಿಂದಾಗಿ ನಿಮ್ಮ ಆರೋಗ್ಯ ಪೂರೈಕೆದಾರರೊಂದಿಗೆ ದೃಢೀಕರಿಸಿ.'
      },
      {
        'question': 'ನನ್ನ ಮೊದಲ ಭೇಟಿಯ ಸಮಯದಲ್ಲಿ ನಾನು ಏನು ಕೇಳಬೇಕು?',
        'answer': 'ಜೀವಸತ್ವಗಳು, ಔಷಧಿಗಳು, ಆಹಾರದ ಶಿಫಾರಸುಗಳು ಮತ್ತು ನೀವು ಮಾಡಬೇಕಾದ ಯಾವುದೇ ಜೀವನಶೈಲಿ ಬದಲಾವಣೆಗಳ ಬಗ್ಗೆ ಕೇಳಿ.'
      },
      {
        'question': 'ನನಗೆ ಯಾವ ಪ್ರದರ್ಶನಗಳು ಬೇಕಾಗುತ್ತವೆ?',
        'answer': 'ಸ್ಕ್ರೀನಿಂಗ್‌ಗಳು ರಕ್ತ ಪರೀಕ್ಷೆಗಳು, ಅಲ್ಟ್ರಾಸೌಂಡ್‌ಗಳು, ಗ್ಲೂಕೋಸ್ ಸ್ಕ್ರೀನಿಂಗ್ ಮತ್ತು ಜೆನೆಟಿಕ್ ಪರೀಕ್ಷೆಯನ್ನು ಒಳಗೊಂಡಿರಬಹುದು.'
      },
    ],
  },
  {
    ...
    'content': [
      {
        ...
        'answer': 'ತಲೆನೋವು ಸಾಮಾನ್ಯವಾಗಬಹುದು; ಆದಾಗ್ಯೂ, ನಿರಂತರ ಅಥವಾ ತೀವ್ರ ತಲೆನೋವು ನಿಮ್ಮ ಆರೋಗ್ಯ ರಕ್ಷಣೆ ನೀಡುಗರೊಂದಿಗೆ ಚರ್ಚಿಸಬೇಕು.'
      },
      {
        'question': 'ನನಗೆ ಸೆಳೆತ ಇದ್ದರೆ ಏನು?',
        'answer': 'ಕೆಲವು ಸೆಳೆತವು ಸಾಮಾನ್ಯವಾಗಬಹುದು, ಆದರೆ ತೀವ್ರವಾದ ಅಥವಾ ನಿರಂತರವಾದ ನೋವನ್ನು ತಕ್ಷಣವೇ ಮೌಲ್ಯಮಾಪನ ಮಾಡಬೇಕು.'
      },
      {
        'question': 'ಗುರುತಿಸುವುದು ಗರ್ಭಪಾತದ ಸಂಕೇತವೇ?',
        'answer': 'ಆರೋಗ್ಯಕರ ಗರ್ಭಾವಸ್ಥೆಯಲ್ಲಿ ಸ್ಪಾಟಿಂಗ್ ಸಂಭವಿಸಬಹುದು, ಆದರೆ ನಿಮ್ಮ ವೈದ್ಯರಿಗೆ ಯಾವುದೇ ರಕ್ತಸ್ರಾವವನ್ನು ವರದಿ ಮಾಡುವುದು ಮುಖ್ಯ.'
      },
      {
        'question': 'ನಾನು ಏಕೆ ಊತವನ್ನು ಅನುಭವಿಸುತ್ತಿದ್ದೇನೆ?',
        'answer': 'ಸೌಮ್ಯವಾದ ಊತವು ಸಾಮಾನ್ಯವಾಗಿದೆ, ಆದರೆ ಹಠಾತ್ ಅಥವಾ ತೀವ್ರವಾದ ಊತವು ಪ್ರಿಕ್ಲಾಂಪ್ಸಿಯಾವನ್ನು ಸೂಚಿಸುತ್ತದೆ ಮತ್ತು ತುರ್ತು ವೈದ್ಯಕೀಯ ಆರೈಕೆಯ ಅಗತ್ಯವಿರುತ್ತದೆ.'
      },
      {
        'question': 'ಎದೆಯುರಿ ಪರಿಹಾರಕ್ಕಾಗಿ ನಾನು ಏನು ಮಾಡಬಹುದು?',
        'answer': 'ಮಸಾಲೆಯುಕ್ತ ಮತ್ತು ಕೊಬ್ಬಿನ ಆಹಾರವನ್ನು ತಪ್ಪಿಸಿ, ಸಣ್ಣ ಊಟವನ್ನು ತಿನ್ನಿರಿ ಮತ್ತು ನಿಮ್ಮ ತಲೆಯನ್ನು ಮೇಲಕ್ಕೆತ್ತಿ ಮಲಗಲು ಪ್ರಯತ್ನಿಸಿ. ನಿಮ್ಮ ವೈದ್ಯರೊಂದಿಗೆ ಸುರಕ್ಷಿತ ಆಂಟಾಸಿಡ್ಗಳನ್ನು ಚರ್ಚಿಸಿ.'
      },
    ],
  },
];
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: FAQScreen(setLocale: (Locale ) { },),
    );
  }
}
